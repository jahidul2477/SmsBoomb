...
\033[1;32m[-] AUTHOR    :\033[1;32m Jahidul Islam
\033[1;32m[-] GITHUB    :\033[1;32m https://github.com/jahidul2477
\033[1;32m[-] FACEBOOK  :\033[1;32m Jahidul Islam
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH Jahidul-2477;) {w}<{r}/{w}>\n\n")
...
os.system("xdg-open https://youtube.com/@Legend192")
print (logo)
print(f"""\n{ran}\033[1;31m                                                               
\t\033[1;32m                 
\t\033[1;32m                
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥Jahidul🔥 "+w+tim)
